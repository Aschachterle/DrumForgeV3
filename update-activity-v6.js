  ...
  try {
    ...
    const payload = {
      ...
      commandLine: [
        ...
        '--file', '"$(args[inputFile].path)"',
        '--output', '"$(args[outputFile].path)"',
        '--script', '"$(appbundles[DrumModifier].path)\\run_drum_modifier.py"'
      ],
      parameters: {
        inputFile: {
          verb: 'get',
    ...
    console.log('Creating Activity version 10 (Updated commandLine for Python script execution)...');
